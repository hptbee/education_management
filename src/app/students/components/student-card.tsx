...
export function StudentCard({ student, teams, classroomRoles, badges, onView, onEdit, onDelete }: StudentCardProps) {
  ...
  return (
    <div
      ...
      className="group ui-card-lift relative flex h-full flex-col items-center rounded-3xl border border-sky-100 bg-white px-3 pb-3 pt-4 text-center shadow-sm transition hover:-translate-y-0.5 hover:border-brand/25 hover:shadow-md focus-within:ring-2 focus-within:ring-brand/30"
    >
