...
export const classroomButtonVariants = cva(
  'inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl font-bold transition-colors ui-press focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100',
  {
    variants: {
      variant: {
