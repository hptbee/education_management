...
const classroomButtonVariants = cva(
  'inline-flex items-center justify-center gap-2 rounded-2xl font-bold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 disabled:pointer-events-none disabled:opacity-50 motion-safe-hover',
  {
    variants: {
      variant: {
